...
* notecoin.conf: contains configuration settings for notecoind or notecoin-qt
* notecoind.pid: stores the process id of notecoind while running
...
* debug.log: contains debug information and general logging generated by notecoind or notecoin-qt
