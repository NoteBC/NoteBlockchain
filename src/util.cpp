...
const char * const BITCOIN_CONF_FILENAME = "notecoin.conf";
const char * const BITCOIN_PID_FILENAME = "notecoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NoteCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/NoteCoin";
#else
    // Unix
    return pathRet / ".notecoin";
#endif
#endif
}
