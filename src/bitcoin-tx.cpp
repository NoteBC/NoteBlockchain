...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s notecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  notecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded notecoin transaction") + "\n" +
              "  notecoin-tx [options] -create [commands]   " + _("Create hex-encoded notecoin transaction") + "\n" +
              "\n";
